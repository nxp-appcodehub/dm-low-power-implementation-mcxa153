...
clock_attach_id_t CLOCK_GetClockAttachId(clock_attach_id_t connection)
{
    ...
    return (clock_attach_id_t)CLK_ATTACH_MUX(reg_offset, actual_sel);
}
...
uint32_t CLOCK_GetClockDiv(clock_div_name_t div_name)
{
    ...
    if (((*pDivCtrl) & (1UL << 30U)) != 0)
    {
        return 0;
    }
    else
    {
        return ((*pDivCtrl & 0xFF) + 1);
    }
}
...
status_t CLOCK_SetupFRO16KClocking(uint8_t clk_16k_enable_mask)
{
    ...
    VBAT0->FROCLKE = VBAT_FROCLKE_CLKE((clk_16k_enable_mask)&VBAT_FROCLKE_CLKE_MASK);
...
static uint32_t CLOCK_GetFroHfFreq(void)
{
    ...
    if (((SCG0->FIRCCSR & SCG_FIRCCSR_FIRCEN_MASK) == 0UL) ||
        ((SCG0->FIRCCSR & SCG_FIRCCSR_FIRC_FCLK_PERIPH_EN_SHIFT) == 0UL))
    {
        freq = 0;
    }
...
static uint32_t CLOCK_GetClk48MFreq(void)
{
    return (((SCG0->FIRCCSR & SCG_FIRCCSR_FIRC_SCLK_PERIPH_EN_MASK) != 0U) ||
            ((SCG0->FIRCCSR & SCG_FIRCCSR_FIRC_SCLK_PERIPH_EN_SHIFT) == 0UL)) ?
               48000000U :
               0U;
}
...
static uint32_t CLOCK_GetClk16KFreq(uint8_t id)
{
    return (((VBAT0->FROCTLA & VBAT_FROCTLA_FRO_EN_MASK) != 0U) &&
            ((VBAT0->FROCLKE & VBAT_FROCLKE_CLKE(id << 1)) != 0UL)) ?
               16000U :
               0U;
}
...
{
    uint32_t freq   = 0U;
    uint32_t clksel = (0 == id) ? (MRCC0->MRCC_CTIMER0_CLKSEL) :
                                  (((1 == id)) ? (MRCC0->MRCC_CTIMER1_CLKSEL) : (MRCC0->MRCC_CTIMER2_CLKSEL));
    uint32_t clkdiv = (0 == id) ? (MRCC0->MRCC_CTIMER0_CLKDIV) :
                                  (((1 == id)) ? (MRCC0->MRCC_CTIMER1_CLKDIV) : (MRCC0->MRCC_CTIMER2_CLKDIV));
...
{
    uint32_t freq   = 0U;
    uint32_t clksel = (0 == id) ? (MRCC0->MRCC_LPSPI0_CLKSEL) : (MRCC0->MRCC_LPSPI1_CLKSEL);
    uint32_t clkdiv = (0 == id) ? (MRCC0->MRCC_LPSPI0_CLKDIV) : (MRCC0->MRCC_LPSPI1_CLKDIV);
...
{
    uint32_t freq   = 0U;
    uint32_t clksel = (0 == id) ? (MRCC0->MRCC_LPUART0_CLKSEL) :
                                  (((1 == id)) ? (MRCC0->MRCC_LPUART1_CLKSEL) : (MRCC0->MRCC_LPUART2_CLKSEL));
    uint32_t clkdiv = (0 == id) ? (MRCC0->MRCC_LPUART0_CLKDIV) :
                                  (((1 == id)) ? (MRCC0->MRCC_LPUART1_CLKDIV) : (MRCC0->MRCC_LPUART2_CLKDIV));
...
{
    uint32_t freq   = 0U;
    uint32_t clksel = (0 == id) ? (MRCC0->MRCC_CMP0_RR_CLKSEL) : (MRCC0->MRCC_CMP1_RR_CLKSEL);
    uint32_t clkdiv = (0 == id) ? (MRCC0->MRCC_CMP0_FUNC_CLKDIV) : (MRCC0->MRCC_CMP1_FUNC_CLKDIV);
...
uint32_t CLOCK_GetCmpRRClkFreq(uint32_t id)
{
    uint32_t freq   = 0U;
    uint32_t clksel = (0 == id) ? (MRCC0->MRCC_CMP0_RR_CLKSEL) : (MRCC0->MRCC_CMP1_RR_CLKSEL);
    uint32_t clkdiv = (0 == id) ? (MRCC0->MRCC_CMP0_RR_CLKDIV) : (MRCC0->MRCC_CMP1_RR_CLKDIV);
...
bool CLOCK_EnableUsbfsClock(void)
{
    ...
    if (0 == (SCG0->FIRCCSR & SCG_FIRCCSR_FIRCEN_MASK))
    {
